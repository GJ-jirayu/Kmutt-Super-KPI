...
public interface EduqaService { 
	...
	//kpi Perspective
	public ResultService saveKpiPerspective(KpiPerspectiveModel kpiLevelModel);
	public ResultService updateKpiPerspective(KpiPerspectiveModel kpiLevelModel);
	public Integer deleteKpiPerspective(KpiPerspectiveModel kpiLevelModel);
	public KpiPerspectiveModel findKpiPerspectiveById(Integer kpiPerspectiveId);
	@SuppressWarnings("rawtypes")
	public  List searchKpiPerspective(KpiPerspectiveModel  kpiLevelModel);
